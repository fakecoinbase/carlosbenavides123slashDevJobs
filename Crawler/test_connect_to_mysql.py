...
def runMigrations(cursor):
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS Remembered_Jobs ( JobID VARCHAR(255) NOT NULL, Company_UUID VARCHAR(255) NOT NULL, ProvidedID VARCHAR(255), isActive TINYINT(1), PRIMARY KEY(JobID), FOREIGN KEY(Company_UUID) REFERENCES Companies(UUID) )")
